...
complete -c discipline -n "__fish_discipline_using_subcommand help; and not __fish_seen_subcommand_from check diff baseline init gates schema self-test completions docs install-hooks hook bench doctor help" -f -a "check" -d 'Run the configured gates. Exit 0 = pass, 1 = violations, 2 = could not check'
complete -c discipline -n "__fish_discipline_using_subcommand help; and not __fish_seen_subcommand_from check diff baseline init gates schema self-test completions docs install-hooks hook bench doctor help" -f -a "diff" -d 'Shorthand for checking uncommitted or working tree changes against HEAD'
complete -c discipline -n "__fish_discipline_using_subcommand help; and not __fish_seen_subcommand_from check diff baseline init gates schema self-test completions docs install-hooks hook bench doctor help" -f -a "baseline" -d 'Record or manage grandfathered finding baselines'
complete -c discipline -n "__fish_discipline_using_subcommand help; and not __fish_seen_subcommand_from check diff baseline init gates schema self-test completions docs install-hooks hook bench doctor help" -f -a "init" -d 'Write a discipline.toml with every available gate at its default'
complete -c discipline -n "__fish_discipline_using_subcommand help; and not __fish_seen_subcommand_from check diff baseline init gates schema self-test completions docs install-hooks hook bench doctor help" -f -a "gates" -d 'List every gate: id, suite, availability, and effective state'
complete -c discipline -n "__fish_discipline_using_subcommand help; and not __fish_seen_subcommand_from check diff baseline init gates schema self-test completions docs install-hooks hook bench doctor help" -f -a "schema" -d 'Print the JSON Schema for discipline.toml'
complete -c discipline -n "__fish_discipline_using_subcommand help; and not __fish_seen_subcommand_from check diff baseline init gates schema self-test completions docs install-hooks hook bench doctor help" -f -a "self-test" -d 'Run the embedded negative / positive controls against this binary'
complete -c discipline -n "__fish_discipline_using_subcommand help; and not __fish_seen_subcommand_from check diff baseline init gates schema self-test completions docs install-hooks hook bench doctor help" -f -a "completions" -d 'Generate shell completion script to stdout (bash, zsh, fish, powershell, elvish)'
complete -c discipline -n "__fish_discipline_using_subcommand help; and not __fish_seen_subcommand_from check diff baseline init gates schema self-test completions docs install-hooks hook bench doctor help" -f -a "docs" -d 'Generate or check reference docs and schemas against sources of truth'
complete -c discipline -n "__fish_discipline_using_subcommand help; and not __fish_seen_subcommand_from check diff baseline init gates schema self-test completions docs install-hooks hook bench doctor help" -f -a "install-hooks" -d 'Install pre-commit hook in the local git repository'
complete -c discipline -n "__fish_discipline_using_subcommand help; and not __fish_seen_subcommand_from check diff baseline init gates schema self-test completions docs install-hooks hook bench doctor help" -f -a "hook" -d 'Run the gates inside a coding agent\'s edit loop (Claude Code, Codex, Cursor, Aider)'
complete -c discipline -n "__fish_discipline_using_subcommand help; and not __fish_seen_subcommand_from check diff baseline init gates schema self-test completions docs install-hooks hook bench doctor help" -f -a "bench" -d 'Benchmark tooling for the bench-regression gate'
complete -c discipline -n "__fish_discipline_using_subcommand help; and not __fish_seen_subcommand_from check diff baseline init gates schema self-test completions docs install-hooks hook bench doctor help" -f -a "doctor" -d 'Check that the repository and its platform enforce discipline: workflows, CODEOWNERS, branch protection. Exit 0 = healthy, 1 = a failing check, 2 = could not check'
complete -c discipline -n "__fish_discipline_using_subcommand help; and not __fish_seen_subcommand_from check diff baseline init gates schema self-test completions docs install-hooks hook bench doctor help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
