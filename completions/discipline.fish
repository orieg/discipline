...
complete -c discipline -n "__fish_discipline_using_subcommand help; and not __fish_seen_subcommand_from check diff baseline init gates schema self-test completions docs install-hooks hook explain replay mcp bench doctor help" -f -a "init" -d 'Write a discipline.toml with every available gate at its default'
...
complete -c discipline -n "__fish_discipline_using_subcommand help; and not __fish_seen_subcommand_from check diff baseline init gates schema self-test completions docs install-hooks hook explain replay mcp bench doctor help" -f -a "hook" -d 'Run the gates inside a coding agent\'s edit loop (Claude Code, Codex, Cursor, Aider)'
