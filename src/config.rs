...
pub const GATES: &[GateInfo] = &[
    ...
    GateInfo {
        ...
        languages: "Rust, Python, JS/TS, Go, Java, C#, PHP, Ruby, C/C++",
        available: true,
    },
    GateInfo {
        id: "error-swallowing",
    ...
    GateInfo {
        ...
        languages: "any (invisible characters, instruction files); Rust, Python, JS/TS, Go, Java, C#, PHP, Ruby, C/C++ and prose files (phrases)",
        available: true,
    },
    GateInfo {
        id: "build-hooks",
