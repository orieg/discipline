...
```yaml
include:
  - remote: 'https://raw.githubusercontent.com/orieg/discipline/v0.12.0/templates/discipline.gitlab-ci.yml'
```
...
- `ghcr.io/orieg/discipline:v0.12.0`
...
2. **Job container, no `uses:` (Gitea Actions, Forgejo Actions, GitHub Actions):**
   ...
   jobs:
     discipline:
       ...
       container:
         image: ghcr.io/orieg/discipline:v0.12.0@sha256:<digest of that release>
       defaults:
         run:
