...
|---|---|---|
| Consumer replay of the v0.11 features | Open | `discipline replay --last 100` on at least one consumer repository shows no false-positive block from the v0.11 language packs, agent-facing checks or `archive-contents` formats |
