...
//!
//! Covers all 38 directives (28 canonical + 10 deprecated aliases).
...
#[test]
fn test_all_38_directives_table_driven_scoping() {
    assert_eq!(
        KNOWN_DIRECTIVES.len(),
        38,
        "KNOWN_DIRECTIVES must contain exactly 38 directives (28 canonical + 10 deprecated)"
    );
    ...
    println!("\n=== TABLE-DRIVEN DIRECTIVE SCOPING RESULTS (38 DIRECTIVES) ===");
    println!(
