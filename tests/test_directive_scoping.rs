...
//!
//! Covers all 34 directives (24 canonical + 10 deprecated aliases).
...
#[test]
fn test_all_34_directives_table_driven_scoping() {
    assert_eq!(
        KNOWN_DIRECTIVES.len(),
        34,
        "KNOWN_DIRECTIVES must contain exactly 34 directives (24 canonical + 10 deprecated)"
    );
    ...
    println!("\n=== TABLE-DRIVEN DIRECTIVE SCOPING RESULTS (34 DIRECTIVES) ===");
    println!(
